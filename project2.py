...
class CableOptimizer:
    def __init__(self, root):
        ...
        self.root.geometry("900x600")  # Slightly reduced width for better proportion
        ...
        # Graph Visualization with adjusted size
        self.figure, self.ax = plt.subplots(figsize=(4.5, 4))  # Reduced to more proportionate size
    ...
    def draw_graph(self):
        ...
        nx.draw(self.nx_graph, pos, ax=self.ax, with_labels=True, node_size=600,  # Reduced node size
                node_color="#81D4FA", font_size=9, font_weight="bold", edge_color="#757575")
        ...
        self.ax.set_title("Current Network Layout", fontsize=11, pad=10)
        self.canvas.draw()
    ...
    def visualize_mst(self, mst_graph):
        ...
        nx.draw(mst_graph, pos, ax=self.ax, with_labels=True, node_size=600,  # Reduced node size
                node_color="#A5D6A7", font_size=9, font_weight="bold", edge_color="#4CAF50")
        ...
        self.ax.set_title("Optimal Network Layout (MST)", fontsize=11, pad=10)
        self.canvas.draw()
